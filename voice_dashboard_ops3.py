...
st.set_page_config(page_title="⚔️ BAŞKOMUTAN OPERASYON MERKEZİ - FULL WAR MODE", page_icon="⚔️", layout="wide")
...
with col_right:
    ...
    pie_chart = ax.pie(values, labels=labels, autopct='%1.1f%%', textprops={'color':'w'},
